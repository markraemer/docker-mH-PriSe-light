...
mysql -u root -proot $DBNAME -B -e "SELECT * INTO OUTFILE '/mnt/data/doc/tempfile.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' FROM $TABLE;"

#(4)merges data file and file w/ column names
cat /mnt/data/doc/tempfile.csv >> $FNAME

#(5)deletes tempfile
rm -rf /mnt/data/doc/tempfile.csv